export default function DiscountInfo() {
    return (
        <div>
            ...
            <button className="mt-[32px] bg-secondaryGreen flex items-center justify-center rounded-[50px] w-full h-[59px]">
            ...
            <div className="flex mt-[12px] border border-gray-300 rounded-[4px] pl-[16px] pr-[16px] pt-[8px] pb-[8px]">
